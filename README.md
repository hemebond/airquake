...
the level. Press 3 to select the stealth fighter, then press right mouse
button to start.
...
Press W to start your engines. Drive to the start of the runway and turn
right. Press W repeatedly to speed up, and look a little upward to take off
...
your carrier has enough defences to take them out.
...
sight, and hold Q key pressed to fly straight while aiming. Look with the
mouse so that the red box is exactly centered to the radar base, and press
left mouse button to release the bomb.

Release the right mouse button (to get back to stealth mode) and Q, and
turn away. If you want, you can now press and hold Q again, and press 9 to
...
to land. Press S to reduce throttle to 75%, dive to low altitude and circle
...
down, reduce throttle to zero by pressing S repeatedly. If it seems you won't
stop quickly enough, speed up with key W and take off (to try again).
...
has all the available information on AirQuake entities. Contact the people at
...
AirQuake TC is copyright 1997-1999, Iikka Keranen.
